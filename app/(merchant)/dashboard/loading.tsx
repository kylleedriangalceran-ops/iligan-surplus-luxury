    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
        <div className="space-y-3">
          <div className="h-8 w-52 bg-[#1C1C1E]/5 skeleton-shimmer rounded-sm" />
          <div className="h-4 w-36 bg-[#1C1C1E]/4 skeleton-shimmer rounded-sm" />
        </div>
        <div className="h-10 w-36 bg-[#1C1C1E]/5 skeleton-shimmer rounded-sm" />
      </div>

      {/* Section header skeleton */}
      <div className="mb-8 flex items-center justify-between">
        <div className="h-4 w-28 bg-[#1C1C1E]/5 skeleton-shimmer rounded-sm" />
        <div className="h-4 w-32 bg-[#1C1C1E]/4 skeleton-shimmer rounded-sm" />
      </div>
