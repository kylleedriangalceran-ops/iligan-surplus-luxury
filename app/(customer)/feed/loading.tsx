      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="mb-16 flex flex-col md:flex-row items-start md:items-end justify-between gap-6 border-b border-[#1C1C1E]/10 pb-8">
          <div className="space-y-4">
            <div className="h-10 w-72 bg-[#1C1C1E]/[0.05] skeleton-shimmer rounded-sm" />
            <div className="h-4 w-96 bg-[#1C1C1E]/[0.04] skeleton-shimmer rounded-sm" />
          </div>
          <div className="h-5 w-32 bg-[#1C1C1E]/[0.04] skeleton-shimmer rounded-sm" />
        </header>
