...
export function SkeletonCard({ index = 0 }: SkeletonCardProps) {
  return (
    ...
    >
      {/* Image skeleton */}
      <div className="relative aspect-[4/5] w-full overflow-hidden bg-[#1C1C1E]/[0.04]">
      ...
      <div className="p-5 space-y-3">
        <div className="space-y-2">
          <div className="h-4 w-3/4 bg-[#1C1C1E]/[0.06] skeleton-shimmer rounded-sm" />
          <div className="h-3 w-1/2 bg-[#1C1C1E]/[0.04] skeleton-shimmer rounded-sm" />
        </div>
        <div className="pt-4 border-t border-[#1C1C1E]/5 flex items-end justify-between">
          <div className="space-y-1.5">
            <div className="h-3 w-14 bg-[#1C1C1E]/[0.04] skeleton-shimmer rounded-sm" />
            <div className="h-4 w-20 bg-[#1C1C1E]/[0.06] skeleton-shimmer rounded-sm" />
          </div>
